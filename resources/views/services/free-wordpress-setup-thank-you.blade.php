...
@section('body')
    <section id="top-content" data-lead-id="top-content">
        <div class="wrapper">
            ...
            <div class="right">
                <h1 data-lead-id="headline"><strong>THANK YOU FOR USING</strong> BLOGGERCASTS.COM</h1>
                <p data-lead-id="content-text">There should be an email in your inbox that asks you for your availability. Please reply to that email.</p>
                <p>If for some reason you have not received that email, you can shoot me one. <a href="mailto:nikhil@bloggercasts.com">Email Nikhil</a></p>
            </div>
            <div class="left">
    ...
    <section id="features">
        <h2 data-lead-id="features-headline">SHARING IS CARING</h2>
        <div class="wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <p class="text-center">
                            Bloggercasts relies on word of mouth to grow its footprint. If you think our offer
                            is cool, share it with your friends, post about us in your favorite Facebook Group
                            or Tweet about us to your followers
                        </p>
                        <br>
                        <p>
                            Shy? No problem. You can still help us by giving us feedback. Tell us what we can
                            improve by emailing Nikhil at nikhil@bloggercasts.com
                        </p>
                    </div>
                </div>
            </div>
